  ...
  return (
    <nav className='navbar'>
        ...
        <div className='desktopMenu'>
          ...
          <Link activeClass='skills' to='intro-section' spy={true} offset={-50} duration={500} className='desktopMenuListItem'>About</Link>
        ...
        <div className='navMenu' style={{display: showMenu? 'flex' : 'none'}}>
          ...
          <Link activeClass='skills' to='intro-section' spy={true} offset={-50} duration={500} className='listItem' onClick={() => setShowMenu(false)}>About</Link>
